...
export default function Navbar() {
  ...
  // ── CHANGED: use NextAuth session instead of custom /api/auth/me ──
  ...
  // ── CHANGED: use NextAuth signOut so both Google + credentials logout ──
    ...
    <>
      ...
      >
        ...
        <div className="px-2 py-4 border-t border-white/10 space-y-1">
          ...
          {/* Logout — shows for both Google and credentials users */}
          {isLoggedIn && (
