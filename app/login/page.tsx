...
export default function LoginPage() {
  ...
  return (
    <div className="flex max-h-screen md:min-h-screen items-center justify-center px-8 pt-32 md:pt-0 md:pb-0">
      <div className="w-full max-w-sm md:max-w-5xl rounded-2xl bg-white p-6 shadow-sm border border-gray-200">
