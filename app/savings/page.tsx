          ...
          {tab === "calculator" && (
            <motion.div key="calc" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} className="space-y-5">
              ...
              <SectionCard title="Deductions">
                <p className="mb-3 text-xs text-white/40">EPF, SOCSO & EIS are calculated automatically using the official KWSP/PERKESO bracket tables.</p>
                <div className="space-y-3">
              ...
              <div className="relative overflow-hidden rounded-3xl border border-[#6A49FA]/30 bg-linear-to-br from-[#6A49FA]/20 to-[#C4B5FD]/10 p-6 backdrop-blur-2xl shadow-[0_8px_40px_rgba(106,73,250,0.25)]">
                ...
                <div className="mt-3 space-y-2 text-sm">
                  <div className="flex justify-between"><span className="text-white/45">EPF (table)</span><span className="text-[#FF8C8C]">− {fmt(breakdown.epfAmount)}</span></div>
                  <div className="flex justify-between"><span className="text-white/45">SOCSO (table)</span><span className="text-[#FF8C8C]">− {fmt(breakdown.socsoAmount)}</span></div>
                  <div className="flex justify-between"><span className="text-white/45">EIS (table)</span><span className="text-[#FF8C8C]">− {fmt(breakdown.eisAmount)}</span></div>
                  {inputs.customDeductions.map((d, i) => (
